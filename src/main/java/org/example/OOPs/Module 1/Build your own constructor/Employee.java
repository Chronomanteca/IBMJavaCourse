...
public class Employee implements Cloneable {
    ...
    public void setName(String name) {
        if(name!= null || !name.isEmpty()){
            ...
            System.out.println("Validation error: name cannot be empty or null");
            this.name = "Unknown";
        }
    }
    ...
    public void setAge(int age) {
        if (age >= 18 && age <= 65){
            ...
            System.out.println("Age has to be between 18 and 65");
            this.age = 18;
        }
    }
    ...
    public void giveRaise(double raisePercentage){
        this.salary += (this.salary*raisePercentage);
    }
    ...
    public String compareSalaries(Employee e){
        return (this.salary > e.salary) ? this.name+" has a higher salary than"+e.getName() : (this.salary < e.getSalary()) ? e.getName()+" has a higher salary than "+this.name : "The salaries are equal";
    }
}
