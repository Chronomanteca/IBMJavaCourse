...
package chrono.ibmcourse.OOPs.Module2.DesigningInterfacesAndAbstractClasses.lab;
...
import chrono.ibmcourse.OOPs.Module2.DesigningInterfacesAndAbstractClasses.lab.model.Guitar;
import chrono.ibmcourse.OOPs.Module2.DesigningInterfacesAndAbstractClasses.lab.model.Instrument;
import chrono.ibmcourse.OOPs.Module2.DesigningInterfacesAndAbstractClasses.lab.model.Piano;

import java.lang.ref.Cleaner;

public class MusicShop{
    public static void main(String[] args){
        Instrument[] instruments = {new Guitar("Guitar", 1972, 5,"Acoustic"), new Piano("Electric piano",2000, 23, false), new Guitar("Slam Jam guitar", 1954,5,"Electric"), new Piano("Classic piano", 1915, 24, true)};
        System.out.println("hello");
        for(Instrument i : instruments){
            System.out.println(i.play());

            if(i instanceof Tunable){
                System.out.println(((Tunable)i).adjustPitch(true));
            }
            if(i instanceof Mantainable){
                System.out.println(((Mantainable)i).clean());
            }
        }
